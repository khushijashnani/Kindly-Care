...
from kindlycare.models import Doctors, Hospitals, Appointments
...
def viewDoctor(doctor_id):
    ...
    if form.validate_on_submit():
        review = Reviews(name=form.name.data, content=form.content.data,
                         rating=form.rating.data, doctor_id=doctor_id)
